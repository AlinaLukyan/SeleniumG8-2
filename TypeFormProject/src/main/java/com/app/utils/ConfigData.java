...
public class ConfigData {
    private static final String CONFIG_FILE = "src/main/resources/config.properties";				//DB connection details, default values for waits
    private static final String UI_MAPPING_FILE = "src/main/resources/ui-map.properties";
